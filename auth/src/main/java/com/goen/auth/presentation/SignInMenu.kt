...
sealed class SignInMenu(var title: String, var icon: Int) {
    ...
    object PrivacyPolicy : SignInMenu("プライバシーポリシー", R.drawable.ic_btn_google_light_normal_ios)
    object TermsOfUse : SignInMenu("利用規約", R.drawable.ic_btn_google_light_normal_ios)
